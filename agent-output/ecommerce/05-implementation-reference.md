...
📁 **Code Location**: [`infra/bicep/ecommerce/`](../../infra/bicep/ecommerce/)
...
└── modules/
    ...
    ├── sql.bicep           # SQL Server with Azure AD auth
    ├── redis.bicep         # Redis Cache
    ├── appservice.bicep    # App Service Plan and Web App
    ├── search.bicep        # Cognitive Search
    ├── servicebus.bicep    # Service Bus Premium
    ├── functions.bicep     # Azure Functions
    ├── frontdoor.bicep     # Front Door with WAF
