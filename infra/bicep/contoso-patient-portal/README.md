...
$appUrl = az webapp show `
  --name app-contoso-patient-portal-prod `
...
This infrastructure is part of the [azure-agentic-infraops](../../) repository demonstrating
GitHub Copilot capabilities for IT professionals.
