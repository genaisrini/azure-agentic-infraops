...
> _(click to show "Documentation Decay" slide)_
>
...
```powershell
cd scenarios/S03-documentation-generation
...
_(Let Copilot generate the architecture documentation)_
...
_Demo script optimized for 30-minute delivery with discovery-based learning focus._
