# S04 Service Validation - Testing Framework

This folder contains service validation scripts for testing the S04 SAIF deployment.
...
- Ensure infrastructure is deployed: `az group exists -n rg-s04-validation-swc01`
- Verify App Services are running: `az webapp list -g rg-s04-validation-swc01 --query "[].state"`
